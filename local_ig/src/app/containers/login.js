        ...
        return (
            <div className={classNames(classes.PopupFormBox, classes.loginSpacer)}>
                <FormControl className={classNames(classes.formControlReviewName, classes.formControlRight)}>
                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="email" className={classes.topLabelFont}>{'email address'}</InputLabel>
...
class SignIn extends React.Component {
    ...
    render() {
        ...
        return (
                <div className={classNames(classes.PopupFormBox, classes.loginSpacer)}>
                    <FormControl className={classNames(classes.formControlReviewName, classes.formControlRight)}>
                        <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="sign-in" className={classes.topLabelFont}>{'sign-in'}</InputLabel>
                        <Input className={classes.textField}
                               id="sign-in"
                               autoComplete="off"
                               value={igLoginId}
...
class Password extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={classNames(classes.PopupFormBox, classes.loginSpacer)}>
                <FormControl className={classNames(classes.formControlReviewName, classes.formControlRight)}>
                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="password" className={classes.topLabelFont}>{'password'}</InputLabel>
                    <Input className={classes.textField}
                           id="password"
                           type="password"
                           autoComplete="off"
