...
class LabelHeader extends React.Component {
    ...
    state = {
        ...
        userNotFound: false,
        dashboardOpen:false,
        associateDetailPopup:false,
        deleteAssociate:false,
        moveAssociate:false,
        reviewAssociate:false,
        reviseAssociate:false,
        suspendAssociate:false,
    ...
    render() {
        ...
        let reviewAssociate=  [
            ...
            {
                show:'information',
                action:this.handleAction(this.handleDiagClosed('ReviewAssociate'), this.props.toggleRightPane, 'associate', this.props.toggleAssesseeMobile, this.props.toggleRightPane,this.props.viewCurrentUser),
                style: classes.optionPrimary
            },
            {
                show:'all',
            ...
            {
                show:'key',
                action:this.handleSelect(reviewOptions, 'key', this.state.reviewOptionsAssociate),
                style: classes.optionSecondary
            }
                    ...
                    <Paper className={showExpand ? classes.expandIconContainer : onlyDashboard ?
                        ...
                        { label==='information' && !readyToPass(card) && (view.right && view.right.associate ) ?
                            <div style={{flex: 2, float: 'right', display: 'flex'}}>
                                ...
                                <div className={classes.iconBox}>
                                     <IconButton onClick={this.handleDiagOpen('associateDetailPopup')}><MoreVert className={classes.iconsBarDefault}/></IconButton>
                                </div>
                                <PopUp
                                    onOpen={this.state.associateDetailPopup}
                                    classes={classes}
                                    previousIcon={classes.backArrow}
                                    textOptions={true}
                                    titleStyle={classes.titleSolidBlue}
                                    title={'associate'}
                                    actionType={this.handleDiagClosed('associateDetailPopup')}
                                    close={this.handleDiagClosed('associateDetailPopup')}
                                    optionList={
                                        [
                                            ...
                                            {
                                                show: 'delete',
                                                action:this.handleDiagOpen('deleteAssociate'),
                                                style:classes.optionPrimary,
                                            ...
                                            {
                                                show: 'move',
                                                action:this.handleDiagOpen('moveAssociate'),
                                                style:classes.optionPrimary,

                                            },
                                            {
                                                show: 'review',
                                                action:this.handleDiagOpen('reviewAssociate'),
                                                style:classes.optionPrimary,

                                            },
                                            {
                                                show: 'revise',
                                                action:this.handleDiagOpen('reviseAssociate'),
                                                style:classes.optionPrimary,
                                            ...
                                            {
                                                show: 'suspend',
                                                action:this.handleDiagOpen('suspendAssociate'),
                                                style:classes.optionPrimary,
                                ...
                                <PopUp
                                    onOpen={this.state.deleteAssociate}
                                    titleStyle={classes.titleLightBlue}
                                    previousIcon={classes.backArrow}
                                    textOptions={true}
                                    actionType={(this.handleDiagClosed('deleteAssociate'),this.handleDiagOpen('associateDetailPopup'))}
                                    classes={classes}
                                    title={'associate'}
                                    badge={true}
                                    badgeStyle={classes.font1_0}
                                    ...
                                    close={this.handleDiagClosed('deleteAssociate')}
                                />
                                <PopUp
                                    onOpen={this.state.moveAssociate}
                                    titleStyle={classes.titleLightBlue}
                                    previousIcon={classes.backArrow}
                                    textOptions={true}
                                    actionType={(this.handleDiagClosed('moveAssociate'),this.handleDiagOpen('associateDetailPopup'))}
                                    classes={classes}
                                    title={'associate'}
                                    badge={true}
                                    badgeStyle={classes.font1_0}
                                    ...
                                    close={this.handleDiagClosed('moveAssociate')}
                                />
                                <PopUp
                                    onOpen={this.state.suspendAssociate}
                                    titleStyle={classes.titleLightBlue}
                                    previousIcon={classes.backArrow}
                                    textOptions={true}
                                    actionType={(this.handleDiagClosed('suspendAssociate'),this.handleDiagOpen('associateDetailPopup'))}
                                    classes={classes}
                                    title={'associate'}
                                    badge={true}
                                    badgeStyle={classes.font1_0}
                                    ...
                                    close={this.handleDiagClosed('suspendAssociate')}
                                />
                                ...
                                <PopUp
                                    ...
                                    previousIcon={classes.backArrow}
                                    textOptions={true}
                                    actionType={(this.handleDiagClosed('reviewAssociate'),this.handleDiagOpen('associateDetailPopup'))}
                                    classes={classes}
                                    title={'associate'}
                                    badge={true}
                                    badgeStyle={classes.font1_0}
                                    ...
                                    close={this.handleDiagClosed('reviewAssociate')}
                                />
                                <PopUp
                                    onOpen={this.state.reviseAssociate}
                                    titleStyle={classes.titleLightBlue}
                                    previousIcon={classes.backArrow}
                                    textOptions={true}
                                    actionType={(this.handleDiagClosed('reviseAssociate'),this.handleDiagOpen('associateDetailPopup'))}
                                    classes={classes}
                                    title={'associate'}
                                    badge={true}
                                    badgeStyle={classes.font1_0}
                                    ...
                                    close={this.handleDiagClosed('reviseAssociate')}
                                />
                            </div> : null}
