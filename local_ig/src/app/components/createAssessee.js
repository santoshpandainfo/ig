                ...
                <div>
                        ...
                        <div className={classes.revisePopupContent}>
                            ...
                            <div className={classes.PopupFormCheckBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="prefixUnlisted" shrink={ true } className={classes.textForLabelPopup}>prefix <sup>unlisted</sup></InputLabel>
                                    <Input
                            ...
                            <div className={classes.PopupFormCheckBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="suffixUnlisted" shrink={ true } className={classes.textForLabelPopup}>suffix <sup>unlisted</sup></InputLabel>
                                    <Input
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormCheckBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel 
                                        htmlFor="email" 
                                        className={classes.textForLabelPopup}
                                        FormLabelClasses={{
                                            root: classes.inputFloatingLabel,
                                            focused: classes.inputFloatingLabelFocused,
                                          }}
                                    >
                                        email address <sup>primary</sup>
                                    </InputLabel>
                                    <Input
                    ...
                    <PopUp
                        ...
                        <div className={classes.revisePopupContent}>
                            ...
                            {(this.state.fields.countryCode === 'unlisted')?
                             <div className={classes.PopupFormCheckBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="countryCodeUnlisted" shrink={ true } className={classes.textForLabelPopup}>country <sup>unlisted</sup></InputLabel>
                                    <Input
                    ...
                    <PopUp
                        ...
                        {(this.state.fields.gender === 'unlisted')?
                            <div className={classes.PopupFormCheckBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="genderUnlisted" shrink={ true } className={classes.textForLabelPopup}>gender <sup>unlisted</sup></InputLabel>
                                    <Input
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormCheckBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop, classes.tagInputs)} style={{ flexDirection: 'row' }}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="tagSecondary" shrink={true} className={classes.textForLabelPopup}>tag <sup className={classes.font1_0}>secondary</sup></InputLabel>
                                    <TextField
