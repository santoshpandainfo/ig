                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="email" className={classes.textForLabelPopup}>email address <sup>{this.state.emailAddress.primary ? 'primary' : 'secondary'}</sup></InputLabel>
                                    {this.state.emailAddress.primary ?
                                        <Input
                                            name="email"
                                            ...
                                            classes={{underline: classes.inputFloatingLabelUnderline}}
                                        /> :
                                        <Input
                                            name="email"
                                            id="reviseAssesseeEmail"
                ...
                <div className={classes.FormBox}>
                    ...
                    <PopUp
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="phone" className={classes.textForLabelPopup}>tag <sup>citizen</sup></InputLabel>
                                    <Input classes={{underline: classes.inputFloatingLabelUnderline}} id="tag" name="text" value="" type="text" />
                                </FormControl>
                ...
                <div className={classes.FormBox}>
                    ...
                    <PopUp
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="guardians" className={classes.textForLabelPopup}>guardians <sup>{ this.state.guaurdianTgl.primary ? 'primary' : 'secondary' }</sup></InputLabel>
                                    <Input classes={{underline: classes.inputFloatingLabelUnderline}} id="guardians" name="guardians" value={this.state.guardians} onChange={this.handleChange} type="text" />
                                </FormControl>
                                <FormHelperText className={classNames(classes.helperText, classes.hide)}>hint/error-message</FormHelperText>
                            </div>
                        </div>
                ...
                <div className={classes.FormBox}>
                    ...
                    <PopUp
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="mentors" className={classes.textForLabelPopup}>mentors <sup>{ this.state.mentorTgl.primary ? "primary" : "secondary" }</sup></InputLabel>
                                    <Input classes={{underline: classes.inputFloatingLabelUnderline}} id="mentors" name="text" value={this.state.mentors} onChange={this.handleChange} type="text" />
                                </FormControl>
                                <FormHelperText className={classNames(classes.helperText, classes.hide)}>hint/error-message</FormHelperText>
                            </div>
                        </div>
                ...
                <div className={classes.FormBox}>
                    ...
                    <PopUp
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="roles" className={classes.textForLabelPopup}>roles <sup>{this.state.rolesTgl.primary ? 'primary' : 'secondary'}</sup></InputLabel>
                                    <Input classes={{underline: classes.inputFloatingLabelUnderline}} id="roles" name="text" value="" type="text" />
                                </FormControl>
                                <FormHelperText className={classNames(classes.helperText, classes.hide)}>hint/error-message</FormHelperText>
                            </div>
                        </div>
                ...
                <div className={classes.FormBox}>
                    ...
                    <PopUp
                        ...
                        <div className={classes.revisePopupContent}>
                            <div className={classes.PopupFormBox}>
                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="tenure" shrink={true} className={classes.textForLabelPopup}>tenure <sup>{this.state.tenureTgl.startDate ? 'start date' : 'end date'}</sup></InputLabel>
                                    <Input
                                        id="tenure"
                                        name="text"
                                    ...
                                    <PopUp
                                        ...
                                        <div className={classes.revisePopupContent}>
                                            <div className={classes.PopupFormBox}>
                                                <FormControl className={classNames(classes.formControl, classes.inputLabelPop)}>
                                                    <InputLabel FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} htmlFor="email" className={classes.textForLabelPopup}>email address <sup>{this.state.emailAddress.primary ? 'primary' : 'secondary'}</sup></InputLabel>
                                                    <Input classes={{underline: classes.inputFloatingLabelUnderline}} id="email" name="email" value={this.state.email} onChange={this.handleChange} />
                                                </FormControl>
                                    ...
                                    <div className={classes.detailsContactContainer}>
                                        ...
                                        <div className={classes.FormBox}>
                                            ...
                                            <PopUp
                                                ...
                                                <div className={classes.revisePopupContent}>
                                                    <div className={classes.PopupFormBox}>
                                                        <FormControl FormLabelClasses={{root: classes.inputFloatingLabel,focused: classes.inputFloatingLabelFocused}} className={classNames(classes.formControl, classes.inputLabelPop)}>
